...
const AccelerographCharts: React.FC = () => {
    ...
    fetch('/api/markers')
      ...
      .then((data: Marker[]) => {
        const filteredData = data.filter(marker => 
          ['Accelerograph REIS Non-Collocated', 'Accelerograph Non-Collocated', 'Accelerograph Collocated'].includes(marker.tipe)
        );
...
export default AccelerographCharts;
